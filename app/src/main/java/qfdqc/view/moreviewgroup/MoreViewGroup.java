package qfdqc.view.moreviewgroup;
...
public class MoreViewGroup extends ViewGroup {
    ...
    MoreScrollView topScrollView, bottomScrollView;
    ...
    public MoreViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MoreViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (MoreScrollView) getChildAt(0);
                bottomScrollView = (MoreScrollView) getChildAt(1);
                topScrollView.setScrollListener(new MoreScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new MoreScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
