...
public class StringUtils {
    ...
    /** GBK */
    public static String StringToGBK(String base64Str) {
        String str = null;
        try {
         str = URLEncoder.encode(base64Str, "GBK");
    ...
    /** UTF-8 */
    public static String StringToUTF(String base64Str) {
        String str = null;
        try {
            str = URLEncoder.encode(base64Str, "UTF-8");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return  str  ;
